...
//  NET-AD
//
//  Created by Mamdouh El Nakeeb on 9/5/18.
...
class ImageCropper: UIView, UIGestureRecognizerDelegate, CropViewDelegate {
...
//        screenWidth = frame.width
    ...
    private func initButton() {
        ...
        rotateButton.frame = CGRect(x: (screenWidth / 4) * 2 - 25, y: screenHeight - 100, width: 50, height: 50)
        ...
        cancelButton.frame = CGRect(x: (screenWidth / 4) * 3 - 25, y: screenHeight - 100, width: 50, height: 50)
        cancelButton.setImage(UIImage(named: "cancel.png"), for: UIControlState.normal)
    ...
    func handleCropViewPanGesture(sender: UIPanGestureRecognizer) {
        ...
        case ImageCropper.LEFT_UP_TAG:
            ...
            break
        case ImageCropper.LEFT_DOWN_TAG:
            if translation.x + cropLeftMargin < imageView.frame.origin.x {
                translation.x = imageView.frame.origin.x - cropLeftMargin
            }
            ...
            break
        case ImageCropper.RIGHT_UP_TAG:
            ...
            break
        case ImageCropper.RIGHT_DOWN_TAG:
            if cropRightMargin - translation.x < screenWidth - (imageView.frame.origin.x + imageView.frame.size.width) {
                translation.x = cropRightMargin - (screenWidth - (imageView.frame.origin.x + imageView.frame.size.width))
            }
            if cropBottomMargin - translation.y < screenHeight - (imageView.frame.origin.y + imageView.frame.size.height) {
            ...
            cropBottomMargin! -= translation.y
            break
        case ImageCropper.LEFT_LINE_TAG:
            if screenWidth - (cropLeftMargin + cropRightMargin + translation.x) < MINIMAL_CROP_VIEW_SIZE {
                translation.x = screenWidth - (cropLeftMargin + cropRightMargin) - MINIMAL_CROP_VIEW_SIZE
            }
            if translation.x + cropLeftMargin < imageView.frame.origin.x {
        ...
        case ImageCropper.UP_LINE_TAG:
            ...
            cropTopMargin! += translation.y
            break
        case ImageCropper.RIGHT_LINE_TAG:
            if cropRightMargin - translation.x < screenWidth - (imageView.frame.origin.x + imageView.frame.size.width) {
                translation.x = cropRightMargin - (screenWidth - (imageView.frame.origin.x + imageView.frame.size.width))
            }
            if screenWidth - (cropLeftMargin + cropRightMargin - translation.x) < MINIMAL_CROP_VIEW_SIZE {
            ...
            cropRightMargin! -= translation.x
            break
        case ImageCropper.DOWN_LINE_TAG:
            if cropBottomMargin - translation.y < screenHeight - (imageView.frame.origin.y + imageView.frame.size.height) {
                translation.y = cropBottomMargin - (screenHeight - (imageView.frame.origin.y + imageView.frame.size.height))
            }
            if screenHeight - (cropTopMargin + cropBottomMargin - translation.y) < MINIMAL_CROP_VIEW_SIZE {
    ...
    @objc func cancelButtonAction(){
        self.delegate?.croppedImg!(image: imageView.image!)
    }
    ...
    private func cropImage() {
        ...
        self.delegate?.croppedImg!(image: croppedImage)
...
@objc protocol CropViewDelegate {
    ...
    @objc optional func croppedImg(image: UIImage)
}
...
private class CropView: UIView {
    ...
    func initCropViewSubViews() {
        ...
        rightLine.tag = ImageCropper.RIGHT_LINE_TAG
        ...
        downLine.tag = ImageCropper.DOWN_LINE_TAG
        ...
        leftUpCornerPoint.tag = ImageCropper.LEFT_UP_TAG
        ...
        leftDownCornerPoint.tag = ImageCropper.LEFT_DOWN_TAG
        ...
        rightUpCornerPoint.tag = ImageCropper.RIGHT_UP_TAG
        ...
        rightDownCornerPoint.tag = ImageCropper.RIGHT_DOWN_TAG
    ...
    override func point(inside point: CGPoint, with event: UIEvent?) -> Bool {
        ...
        for subview in subviews as [UIView] {
            if !subview.isHidden && subview.alpha > 0
                ...
                if subview.tag == ImageCropper.UP_LINE_TAG || subview.tag == ImageCropper.DOWN_LINE_TAG {
                ...
                } else if subview.tag == ImageCropper.LEFT_LINE_TAG || subview.tag == ImageCropper.RIGHT_LINE_TAG {
