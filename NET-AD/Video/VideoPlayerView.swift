...
//        pausePlayButton.frame = CGRect(x: 0, y: frame.height - 61, width: 50, height: 50)
...
//        videoLengthLabel.frame = CGRect(x: frame.maxX - 35, y: frame.height - 61, width: 50, height: 25)
...
//        currentTimeLabel.frame = CGRect(x: pausePlayButton.frame.maxX, y: frame.height - 27, width: 50, height: 25)
...
//        videoSlider.frame = CGRect(x: currentTimeLabel.frame.maxX, y: frame.height - 30, width: videoLengthLabel.frame.minX - currentTimeLabel.frame.maxX, height: 30)
