...
class VideoEditorViewController: UIViewController {
    ...
    let editingTools = ["Merge Videos", /*"Rearrange",*/ "Trim", "Speed", /*"Reverse","Effects", */"Add Text", "Add Watermark"/*, "Texture"*/]
...
extension VideoEditorViewController {
    ...
    func addVideoPlayerView(with width: CGFloat) {
        ...
        videoPlayerView.bringSubview(toFront: self.view)
    }
...
//        self.present(doneActionSheet, animated: true, completion: nil)
    ...
    func addSticker(_ sticker: Int, at position: Int) {
        ...
        stickerLayer.contents = UIImage(named: "stamp\(sticker)")?.cgImage
        ...
        let stickerY = videoHeight * CGFloat(position / 3) / 3 - 20
